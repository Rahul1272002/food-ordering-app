...
const PaymentForm=()=>{
  ...
  const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const { error: backeEndError, clientSecret } = await fetch('http://localhost:8000/create-payment-intent', {
                method: 'POST',
                headers: {
            ...
            if (backeEndError || stripeError) {
                ...
                console.log("backeEndError:",backeEndError)
    ...
    return(
        <form className="md:2/3 md:max-auto px-2 pt-1" id="payment-form" onSubmit={handleSubmit}>
